...
const EditProducts = ({id , selectedProduct , categoriesList}) => {
    ...
    const sendData = (event) =>{
        ...
        formData.append('categories' , data.category.id ? data.category.id : data.category);
        formData.append('categories' , data.subCategory.id ? data.subCategory.id : data.subCategory);
    ...
    <div className="col-md-12 grid-margin stretch-card">
        <div className="card">
            ...
            <div className="forms-sample">
                ...
                <input type="text" name='name' className="form-control form-control-lg" id="exampleInputName" placeholder="نام محصول" value={data.name}  onChange={setDataValue}/>
                </div>
                <div className="form-group">
                <label htmlFor="exampleInputCategory" >دسته بندی</label>
                    <select name='category' id='exampleInputCategory' className="form-control form-control-lg" onChange={e => categoryHandler(e)}>
                        <option selected hidden value={data.category.id}>{data.category.name}</option>
                ...
                <label htmlFor="exampleInputSubCategory" >زیر شاخه</label>
                    <select name='subcategory' id='exampleInputSubCategory' className="form-control form-control-lg" onChange={e => subCategoryHandler(e)}>
                        <option selected hidden value={data.subCategory.id}>{data.subCategory.name}</option>
                       {
                           data.category.id ? 
                           data.category && categoriesList.find(item => item.id == data.category.id).parent.map(data => <option key={data.id} value={data.id}>{data.name}</option>)
                           :
                ...
                <input name='quantity' type="text" className="form-control form-control-lg" id="exampleInputquantity" placeholder="تعداد "  value={data.quantity} onChange={setDataValue}/>
                </div>
                <div className="form-group">
                <label htmlFor="exampleInputBuyPrice">قیمت خرید</label>
                <input name='buyPrice' type="text" className="form-control form-control-lg" id="exampleInputBuyPrice" placeholder="قیمت خرید" value={data.price}  onChange={setDataValue}/>
                </div>
                <div className="form-group">
                <label htmlFor="exampleInputSellPrice">قیمت فروش</label>
                <input name='sellPrice' type="text" className="form-control form-control-lg" id="exampleInputSellPrice" placeholder="قیمت فروش"  value={data.buyPrice} onChange={setDataValue}/>
                </div>
                <div className="form-group">
                <label htmlFor="exampleInputCreator">تولید کننده</label>
                <input name='creator' type="text" className="form-control form-control-lg" id="exampleInputCreator" placeholder="تولید کننده" value={data.creator} onChange={setDataValue} />
                </div>
                <div className="form-group">
                ...
                <textarea name='description' className="form-control form-control-lg" id="exampleTextarea" rows="10" value={data.description} onChange={setDataValue}></textarea>
                </div>
                <div className="form-check form-check-flat">
                        <label className="form-check-label">
                        <input type="checkbox" className="form-check-input" name='is_hide' checked={data.is_hide} value={data.is_hide} onChange={checkboxHandler} /> محصول مخفی <i className="input-helper"></i></label>
                </div>
